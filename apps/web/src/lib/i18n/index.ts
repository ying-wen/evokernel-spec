...
const dict = {
  zh: {
    ...
    'nav.powerThermalMatrix': '电源散热矩阵',
    'nav.opHardwareFitness': '算子硬件适配',
    'nav.kernelLibraries': '算子库目录',
    'nav.isaPrimitives': 'ISA 原语',
    'nav.devToolkit': '开发者工具箱',
    'nav.agents': 'Agents',
    'nav.agentsExample': 'E2E 样例',
    'nav.agentsValidations': '验证矩阵',
    'nav.agentsIntegrations': '集成',
    'nav.agentsDemo': 'E2E Demo',
    'nav.vendors': '厂商',
    'nav.showcase': '精选发现',
    'nav.quality': '数据质量',
    'nav.impact': '影响力',
    ...
    'home.entry.troubleshooting': '部署故障诊断',
    'home.entry.migrations': '迁移指南',
    'home.entry.costOpt': '成本优化',
  ...
  en: {
    ...
    'nav.powerThermalMatrix': 'Power & thermal matrix',
    'nav.opHardwareFitness': 'Op × HW fitness',
    'nav.kernelLibraries': 'Kernel libraries',
    'nav.isaPrimitives': 'ISA primitives',
    'nav.devToolkit': 'Dev toolkit',
    'nav.agents': 'Agents',
    'nav.agentsExample': 'E2E sample',
    'nav.agentsValidations': 'Validations',
    'nav.agentsIntegrations': 'Integrations',
    'nav.agentsDemo': 'E2E Demo',
    'nav.vendors': 'Vendors',
    ...
    'nav.fusionGraph': 'Fusion graph',
    'nav.caseForm': 'Submit a case',
    ...
    'home.entry.troubleshooting': 'Production troubleshooting',
    'home.entry.migrations': 'Migration guides',
    'home.entry.costOpt': 'Cost optimization',
